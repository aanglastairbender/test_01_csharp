...
{
    public partial class CheckTableUpdateUI : Form
    {
        MySqlConnection connNew;
        MySqlConnection connCurrent;
        public CheckTableUpdateUI()
        {
            InitializeComponent();
        }
        ...
        private void tsmiRefresh_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter _daNew = new MySqlDataAdapter("SELECT Table_Name,Column_Name,Column_Type FROM information_schema.COLUMNS WHERE Table_Schema = '" + txtNewDatabase.Text + "' ORDER BY Table_Name,Column_Name ASC;", connNew);
            _daNew.Fill(_dtNew);
            MySqlDataAdapter _daOld = new MySqlDataAdapter("SELECT Table_Name,Column_Name,Column_Type FROM information_schema.COLUMNS WHERE Table_Schema = '" + txtCurrentDatabase.Text + "' ORDER BY Table_Name,Column_Name ASC;", connNew);
            _daOld.Fill(_dtOld);
