...
using oUserGroup = JBC_PMIS_Government.ApplicationObjects.Classes.UserGroup;
    ...
    public partial class UserGroupListUI : Form
    {
        ...
        private void btnSaveRights_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    MessageBoxUI _mb = new MessageBoxUI("Outlet code already exist!", GlobalVariables.Icons.Information, GlobalVariables.Buttons.OK);
                    _mb.showDialog();
                    return;
                }
            }
        ...
        {
            if (!GlobalFunctions.checkRights("tsmUserGroup", "Save"))
            {
                return;
            }
            try
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                UserGroupUI _UserGroup = new UserGroupUI(lUserGroupId, lUserGroupDesc);
                _UserGroup.ParentList = this;
                _UserGroup.ShowDialog();
            }
        }
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            if (lUserGroupId != null)
            {
                ...
                {
                    if (loUserGroup.removeUserGroup(lUserGroupId))
                    {
        ...
        private void tsmSaveRights_Click(object sender, EventArgs e)
        {
