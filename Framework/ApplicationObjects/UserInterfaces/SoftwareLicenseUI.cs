...
namespace JBC_PMIS_Government.ApplicationObjects.UserInterfaces
{
    public partial class SoftwareLicenseUI : Form
    {
        ...
        public SoftwareLicenseUI(string pLGUAgencyName, string pApplicationName)
        {
            InitializeComponent();
            lLGUAgencyName = pLGUAgencyName;
        ...
        public bool sendSoftwareLicenseEmail(string pProcessorId, string pLicenseCode)
        {
            ...
            string _body = "<h4>Date Requested : " + string.Format("{0:MM-dd-yyyy hh:mm tt}", DateTime.Now) + "</h4>" +
                            "<h4>LGU/Agency Name : " + lLGUAgencyName + "</4>" +
            ...
            try
            {
                ...
                mail.Subject = lLGUAgencyName + " : Request for Software License Key!";
        ...
        public bool sendEmailForLicenseKeyRecording(string pProcessorId, string pLicenseKey)
        {
            ...
            try
            {
                ...
                mail.To.Add("jesrylplarisan@gmail.com");
                //mail.CC.Add("jbc.cris2per@gmail.com");
                mail.Subject = "FYI : "+lLGUAgencyName + " successfully acquired a Software License Key!";
                mail.IsBodyHtml = true;
                mail.Body = _body;
        ...
        {
            lblLGUName.Text = lLGUAgencyName;
            lSuccessFullyVerified = false;
        ...
        {
            if (txtKey1.Text == lExpectedValue1 && txtKey2.Text == lExpectedValue2 &&
                txtKey3.Text == lExpectedValue3 && txtKey4.Text == lExpectedValue4)
            {
                if (!sendEmailForLicenseKeyRecording(GlobalFunctions.GetProcessorId(), txtKey1.Text + "-" + txtKey2.Text + "-" + txtKey3.Text + "-" + txtKey4.Text))
                {
                ...
                MessageBoxUI mb = new MessageBoxUI("CONGRATULATIONS!\nLicense has been verified. Thank you for using JBC Softwares!", GlobalVariables.Icons.Information, GlobalVariables.Buttons.OK);
                mb.ShowDialog();
