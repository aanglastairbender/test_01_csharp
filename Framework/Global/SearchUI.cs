    ...
    public partial class SearchUI : Form
    {
        ...
        private string CreateSelectQuery()
        {
            ...
            for (int c = 0; c < lsbDisplayFields.Items.Count; c++)
            {
                ...
                query = query.Insert(query.Length, _Fields + " as `" + _FieldDisplay + "`");
            }
        ...
        private void btnLookUp1_Click(object sender, EventArgs e)
        {
            if (itemHash.ContainsKey(cboField1.Text))
            {
                ...
                {
                    if (cboField1.Text.Contains("Code") || cboField1.Text.Contains("Username") || cboField1.Text.Contains("Id"))
                    {
                        string _classname = "";
        ...
        private void btnLookUp2_Click(object sender, EventArgs e)
        {
            if (itemHash.ContainsKey(cboField2.Text))
            {
                ...
                {
                    if (cboField2.Text.Contains("Code") || cboField2.Text.Contains("Username") || cboField2.Text.Contains("Id"))
                    {
                        string _classname = "";
        ...
        private void btnLookUp3_Click(object sender, EventArgs e)
        {
            if (itemHash.ContainsKey(cboField3.Text))
            {
                ...
                {
                    if (cboField3.Text.Contains("Code") || cboField3.Text.Contains("Username") || cboField3.Text.Contains("Id"))
                    {
                        string _classname = "";
        ...
        private void btnLookUp4_Click(object sender, EventArgs e)
        {
            if (itemHash.ContainsKey(cboField4.Text))
            {
                ...
                {
                    if (cboField4.Text.Contains("Code") || cboField4.Text.Contains("Username") || cboField4.Text.Contains("Id"))
                    {
                        string _classname = "";
        ...
        private void btnLookUp5_Click(object sender, EventArgs e)
        {
            if (itemHash.ContainsKey(cboField5.Text))
            {
                ...
                {
                    if (cboField5.Text.Contains("Code") || cboField5.Text.Contains("Username") || cboField5.Text.Contains("Id"))
                    {
                        string _classname = "";
        ...
        private void btnLookUp6_Click(object sender, EventArgs e)
        {
            if (itemHash.ContainsKey(cboField6.Text))
            {
                ...
                {
                    if (cboField6.Text.Contains("Code") || cboField6.Text.Contains("Username") || cboField6.Text.Contains("Id"))
                    {
                        string _classname = "";
        ...
        private void btnLookUp7_Click(object sender, EventArgs e)
        {
            if (itemHash.ContainsKey(cboField7.Text))
            {
                ...
                {
                    if (cboField7.Text.Contains("Code") || cboField7.Text.Contains("Username") || cboField7.Text.Contains("Id"))
                    {
                        string _classname = "";
        ...
        private void btnLookUp8_Click(object sender, EventArgs e)
        {
            if (itemHash.ContainsKey(cboField8.Text))
            {
                ...
                {
                    if (cboField8.Text.Contains("Code") || cboField8.Text.Contains("Username") || cboField8.Text.Contains("Id"))
                    {
                        string _classname = "";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    loCommon.removeSearchFields(lMenuName, cboTemplateName.SelectedItem.ToString(), ref _Trans);
                }
                //for displayfields
                for (int i = 0; i < lsbDisplayFields.Items.Count; i++)
                {
                    ...
                    loCommon.saveDisplayField(GlobalVariables.Operation.Add, ref _Trans);
                }
